            ...
            <div className="wrapper">
                ...
                <div id="carousel" className="carousel slide" data-ride="carousel" >
                    ...
                    <div className="carousel-inner">
                        ...
                        <div className="carousel-item">
                            <img src="/uploads/banner_image/1682924743_United Arab Emirates (6).jpg" alt="" />
                            <div className="carousel-caption">
                                <p className="animated fadeInRight">Welcome To Equator Interntional</p>
                                <h1 className="animated fadeInLeft">Get Your Dream Job Today
                                </h1>
                        ...
                        <div className="carousel-item">
                            <img src="/uploads/banner_image/1682924194_United Arab Emirates (4).jpg" alt="" />
                            <div className="carousel-caption">
                                <p className="animated fadeInRight">Welcome To Equator Interntional</p>
                                <h1 className="animated fadeInLeft">Get Your Dream Job Today
                                </h1>
                        ...
                        <div className="carousel-item active">
                            <img src="/uploads/banner_image/1682924347_United Arab Emirates (5).jpg" alt="" />
                            <div className="carousel-caption">
                                <p className="animated fadeInRight">Welcome To Equator Interntional</p>
                                <h1 className="animated fadeInLeft">Get Your Dream Job Today
                                </h1>
